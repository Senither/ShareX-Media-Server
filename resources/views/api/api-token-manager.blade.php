<div>
    ...
    <x-jet-form-section submit="createApiToken">
        ...
        <x-slot name="description">
            ...
            A guide for how to setup ShareX with the media server can be found on the
            <a class="text-indigo-700 dark:text-indigo-400 hover:underline"
               target="blank"
               href="https://github.com/Senither/ShareX-Media-Server/wiki/Setting-up-ShareX">project wiki page</a>.
        </x-slot>
                    ...
                    <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        @foreach (Laravel\Jetstream\Jetstream::$permissions as $permission)
                            <label class="flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-600 dark:text-dark-gray-100">{{ $permission }}</span>
                            </label>
                        @endforeach
                    </div>
                </div>
    ...
    <x-jet-dialog-modal wire:model="displayingToken">
        ...
        <x-slot name="content">
            ...
            <x-jet-input x-ref="plaintextToken"
                         type="text"
                         readonly
