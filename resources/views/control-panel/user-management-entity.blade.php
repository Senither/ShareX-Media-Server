<div class="grid grid-cols-12">
    ...
    <div class="p-4 col-span-3 text-left text-sm text-gray-500 dark:text-dark-gray-300">
        <div class="flex space-x-1">
            ...
            <button wire:click="$toggle('confirmingUserEditing')"
                    class="border-2 border-indigo-200 dark:border-dark-gray-800 rounded-md p-1 focus:outline-none">
                <!-- Heroicons: pencil -->
            ...
            @if (!$user->is_admin)
                <button wire:click="$toggle('confirmingUserDeletion')"
                        class="border-2 border-red-200 dark:border-dark-gray-800 rounded-md p-1 focus:outline-none">
                    <!-- Heroicons: trash -->
